...
public class TelaEntediadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Recuperar estado salvo (prefixo 'bored_')
        SharedPreferences prefs = getSharedPreferences("MeusFavoritos", MODE_PRIVATE);
        isFavorited1 = prefs.getBoolean("bored_1", false);
        isFavorited2 = prefs.getBoolean("bored_2", false);
        isFavorited3 = prefs.getBoolean("bored_3", false);
        isFavorited4 = prefs.getBoolean("bored_4", false);
        ...
        if (button != null) {
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.putBoolean("bored_" + buttonId, currentState);
                    editor.apply();
