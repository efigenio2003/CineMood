...
public class TelaBravoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_bravo);

        // Recuperar estado salvo (prefixo 'angry_')
        SharedPreferences prefs = getSharedPreferences("MeusFavoritos", MODE_PRIVATE);
        isFavorited1 = prefs.getBoolean("angry_1", false);
        isFavorited2 = prefs.getBoolean("angry_2", false);
        isFavorited3 = prefs.getBoolean("angry_3", false);
        isFavorited4 = prefs.getBoolean("angry_4", false);
        ...
        if (botaoHome != null) {
            botaoHome.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(TelaBravoActivity.this, MainActivity.class);
        ...
        if (button != null) {
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.putBoolean("angry_" + buttonId, currentState);
                    editor.apply();
